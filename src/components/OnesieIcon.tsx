/**
 * Baby onesie icon — from Noun Project (noun-baby-onesie-3635435, Lourenchyus).
 * Use className="h-full w-auto" to match adjacent column height.
 * Attribution: include "Baby Onesie by Lourenchyus from the Noun Project" in your credits if required by license.
 */
export default function OnesieIcon({ className }: { className?: string }) {
  return (
    <svg
