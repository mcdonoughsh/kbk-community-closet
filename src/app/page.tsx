  ...
  return (
    <div className="min-h-screen bg-[#e6f4ff]">
      ...
      <div className="flex justify-center gap-4 sm:gap-6 px-4 -mt-4 sm:-mt-6">
        <Link
          href="/donate"
          className="px-6 sm:px-8 py-3 sm:py-4 bg-gray-200 text-[#036bb6] rounded-lg text-sm sm:text-base lg:text-lg font-medium hover:bg-gray-300 transition-colors"
        >
          Donate
        </Link>
        <Link
          href="/request"
          className="px-6 sm:px-8 py-3 sm:py-4 bg-[#036bb6] text-white rounded-lg text-sm sm:text-base lg:text-lg font-medium hover:bg-[#025a9a] transition-colors"
        >
          Request
        </Link>
      </div>
